...
Item {
    ...
    property string borderColor: isDarkMode ? _get("theme.colors.border_dark", "#4d4239") : _get("theme.colors.border", "#cbbda8")
    property string accentColor: _get("theme.colors.accent", "#a05e26")
    property string textPrimary: isDarkMode ? _get("theme.colors.text_primary_dark", "#f5e0c3") : _get("theme.colors.text_primary", "#2d2722")
    property string textSecondary: isDarkMode ? _get("theme.colors.text_secondary_dark", "#a0988e") : _get("theme.colors.text_secondary", "#8a7e72")
    property string textOnDark: isDarkMode ? _get("theme.colors.text_on_dark_dark", "#2d2722") : _get("theme.colors.text_on_dark", "#f5e0c3")
    property string surfaceColor: isDarkMode ? _get("theme.colors.surface_dark", "#3d352d") : _get("theme.colors.surface", "#d4c4b0")
    property string hoverColor: isDarkMode ? _get("theme.colors.hover_dark", "#24ffffff") : _get("theme.colors.hover", "#24000000")
    property string hoverLight: isDarkMode ? _get("theme.colors.hover_light_dark", "#12ffffff") : _get("theme.colors.hover_light", "#12000000")
