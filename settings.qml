...
Item {
    ...
    // theme colors
    property string backgroundColor: syncModeEnabled ? (isDarkMode ? "#2d2722" : "#e6dcce") : (isDarkMode ? _get("theme.colors.background_dark", "#2d2722") : _get("theme.colors.background", "#e6dcce"))
    property string backgroundDark: syncModeEnabled ? (isDarkMode ? "#e6dcce" : "#2d2722") : (isDarkMode ? _get("theme.colors.background", "#e6dcce") : _get("theme.colors.background_dark", "#2d2722"))
    property string borderColor: syncModeEnabled ? (isDarkMode ? "#4d4239" : "#cbbda8") : (isDarkMode ? _get("theme.colors.border_dark", "#4d4239") : _get("theme.colors.border", "#cbbda8"))
    property string accentColor: _get("theme.colors.accent", "#a05e26")
    property string textPrimary: syncModeEnabled ? (isDarkMode ? "#f5e0c3" : "#2d2722") : (isDarkMode ? _get("theme.colors.text_primary_dark", "#f5e0c3") : _get("theme.colors.text_primary", "#2d2722"))
    property string textSecondary: syncModeEnabled ? (isDarkMode ? "#a0988e" : "#8a7e72") : (isDarkMode ? _get("theme.colors.text_secondary_dark", "#a0988e") : _get("theme.colors.text_secondary", "#8a7e72"))
    property string textOnDark: syncModeEnabled ? (isDarkMode ? "#2d2722" : "#f5e0c3") : (isDarkMode ? _get("theme.colors.text_on_dark_dark", "#2d2722") : _get("theme.colors.text_on_dark", "#f5e0c3"))
    property string surfaceColor: syncModeEnabled ? (isDarkMode ? "#3d352d" : "#d4c4b0") : (isDarkMode ? _get("theme.colors.surface_dark", "#3d352d") : _get("theme.colors.surface", "#d4c4b0"))
    property string hoverColor: syncModeEnabled ? (isDarkMode ? "#24ffffff" : "#24000000") : (isDarkMode ? _get("theme.colors.hover_dark", "#24ffffff") : _get("theme.colors.hover", "#24000000"))
    property string hoverLight: syncModeEnabled ? (isDarkMode ? "#12ffffff" : "#12000000") : (isDarkMode ? _get("theme.colors.hover_light_dark", "#12ffffff") : _get("theme.colors.hover_light", "#12000000"))
